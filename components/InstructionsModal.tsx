    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-2xl bg-gradient-to-b from-zinc-900 to-black border border-green-900/50 rounded-2xl overflow-hidden shadow-2xl"
        >
          {/* Header */}
          ...
          <div className="p-6 md:p-8">
            <div className="flex flex-col md:flex-row gap-8">
              {/* Left: Step Icon & Navigation */}
              <div className="md:w-1/3">
                <div className="text-center mb-8">
                  <div className="text-6xl mb-4">{steps[currentStep - 1].icon}</div>
                  <div className="inline-flex items-center gap-2 text-green-500 font-bold">
                  ...
                  <div className="space-y-3 mb-8">
                    {steps[currentStep - 1].details.map((detail, index) => (
                      <div key={index} className="flex items-start gap-3">
                        <div className="w-6 h-6 rounded-full bg-green-900/30 border border-green-800 flex items-center justify-center text-green-500 text-xs mt-0.5">
                          ✓
                        </div>
                  ...
                  {currentStep === 1 && (
                    <div className="bg-black/50 p-4 rounded-xl border border-zinc-800 mb-6">
                      <div className="grid grid-cols-2 gap-4 text-center">
                        ...
                        {/* <div>
                          <div className="text-2xl mb-2">🥷🏻</div>
                          <div className="text-xs text-gray-400">Authenticate</div>
                        </div> */}
                      </div>
                    </div>
                  )}
          ...
          {/* Footer */}
          <div className="p-6 border-t border-zinc-800 bg-black/30">
            <div className="flex justify-between items-center">
              <button
                onClick={prevStep}
              ...
              <button
                onClick={nextStep}
                className="px-6 py-3 rounded-lg font-medium bg-gradient-to-r from-green-600 to-emerald-500 hover:from-green-500 hover:to-emerald-400 text-black transition-all"
              >
